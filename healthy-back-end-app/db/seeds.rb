...
},
{
    ...
    img: "https://i1.wp.com/ohmyveggies.com/wp-content/uploads/2017/05/vegan-greek-salad-with-tofu-feta-3.jpg",
...
},
{
    ...
    img: "https://www.bbcgoodfood.com/sites/default/files/recipe_images/recipe-image-legacy-id--327831_11.jpg",
    restaurant: Restaurant.find(2)
...
},
{
    ...
    img:"http://www.alkhafeef.com.sa/wp-content/uploads/2014/03/CHICKEN-SANDWICH1.jpg",
...
},
{
    ...
    img: "https://www.subway.com/ns/images/menu/SAU/ENG/RPLC-Chicken-Teriyaki_594x334_PR.jpg",
    restaurant: Restaurant.find(4)
},
{
    ...
    img: "https://www.subway.com/ns/images/menu/SAU/ENG/RPLC-Roasted_chicken_594x334_PR.jpg",
...
},
{
    ...
    img: "https://roma-way.com/wp-content/uploads/2018/10/kids_m_1-364x250.jpg",
    restaurant: Restaurant.find(5)

}]

menus.each do |menu|
    Menu.create(dish_item: menu[:dish], price: menu[:price], calories: menu[:calories], description: menu[:description], img: menu[:img] , restaurant: menu[:restaurant])
    # p menu[:dish]
end 
